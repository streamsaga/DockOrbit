// All countries (ISO 3166-1 alpha-2) and common languages (ISO 639-1)
// for the discovery filters. The backend already accepts any valid code
// via the `country` and `language` query params.
